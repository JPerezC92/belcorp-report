...
export const preloadApiKeys = {
	...
	loadSBOperationalStabilityData: btoa("loadSBOperationalStabilityData") as keyof Window,
	getSBOperationalReleases: btoa("getSBOperationalReleases") as keyof Window,
	dropSBOperationalStabilityData: btoa("dropSBOperationalStabilityData") as keyof Window,
	...
	getLevelMappings: btoa("getLevelMappings") as keyof Window,
	createLevelMapping: btoa("createLevelMapping") as keyof Window,
	updateLevelMapping: btoa("updateLevelMapping") as keyof Window,
	deleteLevelMapping: btoa("deleteLevelMapping") as keyof Window,
};
