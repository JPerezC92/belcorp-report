...
export function excelTagDtoToDomain(dto: ExcelTagDto): Tag {
	return Tag.create({
		...
		...(dto.requestId.link && { requestIdLink: dto.requestId.link }),
		additionalInfo: dto.additionalInfo,
		module: dto.module,
		problemId: dto.problemId.value,
		...(dto.problemId.link && { problemIdLink: dto.problemId.link }),
		linkedRequestId: dto.linkedRequestId.value,
		...(dto.linkedRequestId.link && { linkedRequestIdLink: dto.linkedRequestId.link }),
		jira: dto.jira,
